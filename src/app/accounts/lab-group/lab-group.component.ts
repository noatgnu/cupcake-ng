...
export class LabGroupComponent implements OnInit {
  ...
  editLabGroup(labGroup: LabGroup) {
    ...
    ref.closed.subscribe((data) => {
      if (data) {
        this.web.updateLabGroup(data.id, data.name, data.description, data.default_storage_id, data.service_storage_id, data.can_perform_ms_analysis, data.is_core_facility).subscribe((data) => {
  ...
  addLabGroup() {
    ...
    ref.closed.subscribe((data) => {
      if (data) {
        this.web.createLabGroup(data.name, data.description, data.can_perform_ms_analysis, data.is_core_facility).subscribe(() => {
          this.web.getLabGroups().subscribe((data) => {
            this.labGroupQuery = data
          })
        })
